export default async function handler(req, res) {
  ...
  if (
    !table ||
    !["concrete_data", "certs_data", "tm_data"].includes(table)
  ) {
  ...
  if (table === "tm_data") {
    ...
    if (data.labourEntries !== undefined) {
      payload.labourEntries = data.labourEntries;
    }

    if (data.submittedWeeks !== undefined) {
      payload.submittedWeeks = data.submittedWeeks;
    }
  }
